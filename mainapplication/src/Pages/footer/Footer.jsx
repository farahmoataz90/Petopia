        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-2 col-md-3 col-sm-6 offset-lg-1">
                    <div className="mb-4">
                        <h3 className="fw-bold mb-3 foff">Company</h3>
                ...
                <div className="col-lg-2 col-md-3 col-sm-6">
                    <div className="mb-4">
                        <h3 className="fw-bold mb-3 foff">Support</h3>
                        <ul className="nav nav-footer flex-column nav-x-0 list-unstyled">
                            <li className=" ">
                ...
                <div className="col-lg-3 col-md-12 col-sm-12">
                    <div className="mb-4">
                        <h3 className="fw-bold mb-3 foff">Get in touch</h3>
                        <p>339 McDermott Points Hettingerhaven, NV 15283</p>
                        <p className="mb-1">Email: <a href="/marketing/landings/landing-education/">support@petopia.com</a></p>
            ...
            <div className="align-items-center g-0 border-top py-2 mt-6 row bg-transparent">
                ...
                <div className="d-md-flex justify-content-end col-lg-8 col-md-7 col-sm-12">
                    <nav className="nav nav-footer bg-transparent border-0 navnav shadow-none">
                        <a className="nav-link ps-0 bg-transparent" href="..">Privacy Policy</a>
                        <a className="nav-link px-2 px-md-3 bg-transparent" href="..">Cookie Notice </a>
                        <a className="nav-link d-none d-lg-block bg-transparent" href="..">Do Not Sell My Personal Information </a>
                        <a className="nav-link bg-transparent" href="..">Terms of Use</a>
                    </nav>
                </div>
            </div>
        </div>
